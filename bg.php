 ...
 <nav class="navbar navbar-default">
    ...
    <table align='center'>
        ...
        <tr>
            ...
            <td>
                <a href="editbg.php?id=<?php echo $ID ?>">Change Colour</a>
            </td>
        </tr>
    </table>
    <?php   }
...
<?php
    ...
    <table align='center'>
        <tr>
            <th>Navigation Text Colour</th>
            <th>Navigation Hover Colour</th>
        </tr>
        <tr>
            <td>
                <?php echo $row["ntxt"];?>
            ...
            <td>
                <a href="editNav.php?id=<?php echo $ID; ?>">Change Colours</a>
            </td>
        </tr>
    </table>
    <?php   }
