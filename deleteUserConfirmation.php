...
<nav class="navbar navbar-default">
        ...
        <div class="container1">
            ...
            <a href ="deleteusers.php?id=<?php echo $id ?>"><button name="signup"  class="submit" style="font-size: 15px">YES</button></a>



            <a href="admin.php?id=<?php echo $id ?>"><button name="signup"  class="submit" style="font-size: 15px">NO</button></a>
