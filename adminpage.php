...
<body>
 ...
 <nav class="navbar navbar-default">
    ...
    <a href="back.php?id=<?php echo $ID ?>"><button class="button button1">Back To Homepage</button></a><br>
    <a href="addpage.php?id=<?php echo $ID ?>"><button class="button button1">Add New Page</button></a>
    ...
    <table align='center'>
        ...
        <tr>
            ...
            <td><a href="pagename.php?ID=<?php echo $ID ?>&id=<?php echo $row["id"];?>">Change Page Name</a></td>
            <td><a href="editPage.php?ID=<?php echo $ID ?>&id=<?php echo $row["id"];?>">Edit Page</a></td>
            <td><a href="deletePageConfirmation.php?id=<?php echo $row["id"];?>&ID=<?php echo $ID ?>">Delete</a></td>
        </tr>
        <?php   }
    } else {
        echo "0 results";
