...
<nav class="navbar navbar-default">
    ...
    <div class="container1">
        ...
        <br>
        <a href="deletePage2.php?id=<?php echo $id ?>&ID=<?php echo $ID ?>"><button name="signup" class="submit" style="font-size: 15px"> YES </button> </a>
        <a href="userpage.php?id=<?php echo $ID ?>"><button name="signup" class="submit" style="font-size: 15px">NO</button></a>
    </div>
