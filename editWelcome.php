...
<body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="social-wrapper">
                    <div class="col-md-6">
                        <a href="index.php<?php echo $ID ?>" target="_blank"><i>
 ...
 <nav class="navbar navbar-default">
        ...
        <a href="welcome.php?id=<?php echo $ID ?>"><button class="button button1">Back To Welcome Text Colour</button></a>


        <?php

    $sql = "SELECT welcome FROM contactdetails where user = $ID";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) { ?>
        <div class="container1">
            <form action="editWelcome2.php?id=<?php echo $ID ?>" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <label>Colour</label>
                    <div>
                        <input type="color" name="welcome" id="welcome" value="<?php echo $row["welcome"];?>" required>
                    </div>
                    <br>
                    <div>
