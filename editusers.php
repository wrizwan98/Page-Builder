...
<body>
 ...
 <nav class="navbar navbar-default">
        ...
        <a href="admin.php?id=<?php echo $ID; ?>"><button class="button button1">Back To Users</button></a>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) { ?>
        <div class="container1">
            <form action="editusers2.php?id=<?php echo $ID;?>" method="post" enctype="multipart/form-data" onsubmit="var text = document.getElementById('username').value; if(text.length < 11) { alert('Phone Number is incorrect.'); return false; }if(text.length > 11) { alert('Phone Number is incorrect.'); return false; } return true;">
