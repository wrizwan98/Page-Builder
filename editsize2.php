 ...
 <nav class="navbar navbar-default">
    ...
    <div class="container">
        <?php
				...
				$sqli = "UPDATE contactdetails SET h = '$h', w = '$w' where user = $ID";
				$retval = mysqli_query($conn, $sqli);
				
				if($retval) {
					echo "Sizes changed successfully";  
					}else {
					die('Sizes not changed: '. mysqli_error($conn));
			...
			?>
        <p>Click <a href="admindetails.php?id=<?php echo $ID; ?>">here</a> to go back</p>
