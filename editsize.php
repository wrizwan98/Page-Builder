...
<body>
 ...
 <nav class="navbar navbar-default">
        ...
        <a href="admindetails.php?id=<?php echo $ID; ?>"><button class="button button1">Back To Logo</button></a>
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) { ?>
        <div class="container1">
            <form action="editsize2.php?id=<?php echo $ID ?>" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <label>Height</label>
                    <div>
                        <input type="text" name="h" id="h" value="<?php echo $row["h"];?>" required>
                    </div>
                    <label>Width</label>
                    <div>
                        <input type="text" name="w" id="w" value="<?php echo $row["w"];?>" required>
                    </div>
                    <br>
                    <div>
