...
<nav class="navbar navbar-default">
    ...
    <div class="container">
        <?php
				...
				$sqli = "UPDATE customers SET Password = '$Password', Address = '$Address', Email = '$Email', Username = '$Username', name = '$Name' where id = $ID";
			...
			?>
        <p>Click <a href="adminusers.php">here</a> to go back</p>
