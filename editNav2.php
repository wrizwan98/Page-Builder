...
<nav class="navbar navbar-default">
    ...
    <div class="container">
        <?php
				...
				$sqli = "UPDATE contactdetails SET ntxt = '$TXT', nhover = '$HOVER' where user = $ID";
				$retval = mysqli_query($conn, $sqli);
				
				if($retval) {
					echo "Colours changed successfully";  
					}else {
					die('Colours not changed: '. mysqli_error($conn));
					
					mysqli_close($conn);
					
				}
    
    header("Location:bg.php?id=$ID");
			?>
        <p>Click <a href="nav.php?id=<?php echo $ID; ?>">here</a> to go back</p>
