...
$sql1 = "UPDATE `home` SET `content`= '".$content."' WHERE `user` = $ID";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="back.php?id=<?php echo $ID ?>" >Back to Homepage <span class="sr-only"></span></a></li>
          <li class="active"><a href="#" id="save">Save <span class="sr-only"></span></a></li>
          <li class="active"><a href="index.php?id=<?php echo $ID ?>" target="_blank" >View Page <span class="sr-only"></span></a></li>
        ...
        <?php
            ...
            $sql2 = "SELECT `content` FROM `home` WHERE `user` = $ID";
