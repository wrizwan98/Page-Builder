    ...
    while($row = $result->fetch_assoc()) { ?>        
        ...
        <div class="container1">
            <div class="imgcontainer1">
                <form action="pagename2.php?id=<?php echo $id ?>&ID=<?php echo $ID ?>" method="post" enctype="multipart/form-data">
                    <div>
                        <div>
                    ...
                    <div>
                        ...
                        <br>
                        <div>
                            <button name="signup" class="submit" style="font-size: 15px">Change</button>
                        </div>
                    </div>
                </form>
                <br>
