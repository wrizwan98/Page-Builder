...
<body>
 ...
 <nav class="navbar navbar-default">
    ...
    <body>
        <a href="admindetails.php?id=<?php echo $ID ?>"><button class="button button1">Back To Company Details</button></a><br>

        <?php

    $sql = "SELECT logo FROM contactdetails where user = $ID";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) { ?>
        ...
        <div class="container1">
            <form action="editLogo2.php?id=<?php echo $ID; ?>" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <p><font color="white">Select an image:</font></p>
                    <input style="background-color:white;" type="file" id="image" name="image" value="<?php echo $row["image"];?>"><br>

                    <div>

                        <button class="submit" name="submit">Change</button>
                    </div>
                </div>
            </form>
