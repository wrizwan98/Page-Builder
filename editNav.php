...
<body>
 ...
 <nav class="navbar navbar-default">
        ...
        <a href="welcome.php?id=<?php echo $ID; ?>"><button class="button button1">Back To Navbar Colours</button></a>


        <?php

    $sql = "SELECT * FROM contactdetails where user = $ID";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) { ?>
        <div class="container1">
            <form action="editNav2.php?id=<?php echo $ID; ?>" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <div>
                        <input type="color" name="txt" id="txt" value="<?php echo $row["ntxt"];?>" required>
						
                    </div>
                    <label>Hover Colour</label>
                    <div>
                        <input type="color" name="hover" id="hover" value="<?php echo $row["nhover"];?>" required>
                    </div>                    
                    <br>
                    <div>
